/**
 * The Vibe Database
 * Each vibe has a persona, an activity, and a playful instruction.
 */
export const vibes = [
    {
...
export const phrases = {
    thinking: [
        ...
        "Loading personality...",
        "Calculating existential dread...",
        "Reading the room..."
    ],
    easterEgg: [
        "Okay… you’re clearly procrastinating 😏",
        "Stop clicking, I'm thinking! 😤",
        "Do absolutely nothing today. You earned it. 🏆" // Rare
    ]
};
